...
def get_args():
    ...
    parser.add_argument('--mpath', default='pth/UNet2DShift/milestone')
...
def genoff_tsn(model, mname, batch_size, core_number, in_height, in_width,
    ...
    from models.unet import UNet2DShiftMLU
...
if __name__ == "__main__":
    ...
    if autotune:
        mname = './{}/{}_auto_{}x{}_{}_t{}bs{}c{}{}'.format(platform_name, model, in_width, in_height, platform_name, args.t ,batch_size, core_number, fpX)
    else:
        mname = './{}/{}_{}x{}_{}_t{}bs{}c{}{}'.format(platform_name, model, in_width, in_height, platform_name, args.t ,batch_size, core_number, fpX)
