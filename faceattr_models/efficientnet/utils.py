...
class Conv2dStaticSamePadding(nn.Conv2d):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, image_size=None, padding = 0, dilation=1, groups=1, bias=True):
...
local_map = {
    'efficientnet-b3': '/mnt/projects/FaceAttributes/weights/efficientnet-b3-5fb5a3c3.pth',
}
...
def load_pretrained_weights(model, model_name, weights_path=None, load_fc=True, advprop=False, verbose=True):
    ...
    elif os.path.exists(local_map[model_name]):
        state_dict = torch.load(local_map[model_name])
    else:
