...
def get_args():
    ...
    parser.add_argument('--mpath', default='pth/UNetResNet18_Shift/bs2/milestone')
...
def genoff_tsn(model, mname, batch_size, core_number, in_height, in_width,
    ...
    from models.unet import UNetResNet18_Shift_MLU

    model_path = args.mpath
    model_online_fullname = pj(model_path, 'mlu_{}_{}_{:d}x{:d}.pth'.format(dtype, model,in_width, in_height))
    ...
    use_firstconv = True
    loading = False
    net = UNetResNet18_Shift_MLU(n_classes=1, n_segment=T)
    print('==end==')
    net = net.eval().float()
...
if __name__ == "__main__":
    ...
    if autotune:
        mname = './{}/{}_auto_{}x{}_{}_t{}bs{}c{}{}_{}'.format(platform_name, model, in_width, in_height, platform_name, args.t ,batch_size, core_number, fpX, dtype)
    else:
        mname = './{}/{}_{}x{}_{}_t{}bs{}c{}{}_{}'.format(platform_name, model, in_width, in_height, platform_name, args.t ,batch_size, core_number, fpX, dtype)
